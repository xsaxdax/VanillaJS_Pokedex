...
const cardTemplate = (id, name) => {
  return `
  <div class="card ${name}" height="108" width="104" style="overflow: hidden; border:1px solid silver; border-radius: 8%; background: #FFFFFF;">
      ...
      return new Promise((resolve) => {
        fetch(api)
          ...
          .then((data) => {
            ...
            let t = cardTemplate(result[0].ID, result[0].name)
            resolve(result);
          })
          .catch((error) => {
            console.error(error);
